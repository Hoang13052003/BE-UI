      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        <Col span={8}>
          <Card>
            ...
            <Title level={2} style={{ margin: '16px 0' }}>75%</Title>
            <Progress percent={75} />
        ...
        <Col span={8}>
          <Card>
            ...
            <Title level={2} style={{ margin: '16px 0' }}>4/6</Title>
            <Space size={24}>
              <Space>
                <Text>Completed</Text>
        ...
        <Col span={8}>
          <Card>
            ...
            <Title level={2} style={{ margin: '16px 0' }}>3</Title>
            <Space>
          ...
          <TabPane tab="Overview" key="overview">
            <Row gutter={24}>
              <Col span={12}>
                ...
                <Paragraph>
                  Custom e-commerce solution with advanced features including payment integration,
                  inventory management, and analytics dashboard.
                </Paragraph>

                <Title level={5}>Project Details</Title>
                <Descriptions column={1}>
                  <Descriptions.Item label="Client">Tech Corp</Descriptions.Item>
                  <Descriptions.Item label="Project Manager">John Smith</Descriptions.Item>
                  <Descriptions.Item label="Project Type">Fixed</Descriptions.Item>
